...
*Auto-generated on 2026-04-25 06:41 UTC*
...
**Memory:** 986.7 MB / 3.8 GB (25.3% used)
...
|------|-------|-------|--------|
| docker-proxy-1 | `nginx:1-alpine` | 1236:1236, 1236:1236, 8536:8536 | Up 24 hours |
| docker-lemmy-ui-1 | `dessalines/lemmy-ui:0.19.14` | 1234/tcp | Up 24 hours (healthy) |
| docker-lemmy-1 | `ghcr.io/gunswayfm/niteridefm_grid:latest` | 10002:10002, 10002:10002 | Up 24 hours |
...
| Load Average | 0.04, 0.05, 0.00 |

**Memory:** 978.5 MB / 5.8 GB (16.6% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 15.1 GB | 97.1 GB | 14% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| stream-probe | 9100 | online | 72 MB | 2.8% | 39 |
...
**Memory:** 922.8 MB / 5.8 GB (15.6% used)
...
| streaming-core | - | online | 100 MB | 2.9% | 21 |
...
| Kernel | 6.8.0-39-generic |
| Load Average | 6.94, 7.01, 6.93 |

**Memory:** 2.7 GB / 15.6 GB (17.1% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 156.4 GB | 38.8 GB | 111.1 GB | 26% |
...
| playlist-generator-ch2 | 9050 | online | 79 MB | 3% | 1 |
| storage-service-ch2 | - | online | 164 MB | 0% | 24 |
| stream-guard-ch2 | - | online | 80 MB | 0% | 0 |
| stream-monitor-ch2 | - | online | 77 MB | 0% | 15 |
| cdn-prewarmer-ch2 | - | online | 106 MB | 0% | 15 |
| content-segmenter-ch2 | - | online | 75 MB | 0% | 0 |
| rtmp-receiver-ch2 | - | online | 80 MB | 0% | 0 |
