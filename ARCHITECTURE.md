...
*Auto-generated on 2026-03-28 06:30 UTC*
...
**Memory:** 953.4 MB / 3.8 GB (24.4% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 52.8 GB | 29.5 GB | 20.6 GB | 59% |
...
| docker-proxy-1 | `nginx:1-alpine` | 1236:1236, 1236:1236, 8536:8536, 8536:8536 | Up 11 days |
| docker-lemmy-ui-1 | `dessalines/lemmy-ui:0.19.14` | 1234/tcp | Up 11 days (healthy) |
| docker-pictrs-1 | `asonix/pictrs:0.5.16` | 6669/tcp, 8080/tcp | Up 11 days |
| docker-postgres-1 | `pgautoupgrade/pgautoupgrade:16-alpine` | 5433:5432, 5433:5432 | Up 11 days (healthy) |
...
| Load Average | 0.16, 0.13, 0.06 |

**Memory:** 5.0 GB / 5.8 GB (86.9% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 13.6 GB | 98.6 GB | 13% |
...
**Memory:** 908.3 MB / 5.8 GB (15.4% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 8.4 GB | 103.8 GB | 8% |
...
| identity-service | 3001 | online | 96 MB | 0% | 18 |
| chat-service | 4000 | online | 94 MB | 0% | 3 |
...
**Memory:** 1.4 GB / 5.8 GB (23.8% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 38.7 GB | 73.5 GB | 35% |
...
| stream-guard | - | online | 80 MB | 2.8% | 1 |
...
| storage-service | - | online | 87 MB | 2.8% | 2 |
| rtmp-receiver | - | online | 86 MB | 0% | 1 |
...
| OS | Ubuntu 24.04.1 LTS |
| Kernel | 6.8.0-39-generic |
| Load Average | 8.04, 6.99, 6.88 |

**Memory:** 2.1 GB / 15.6 GB (13.3% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 156.4 GB | 31.7 GB | 118.2 GB | 22% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| streaming-core-ch2 | - | online | 94 MB | 0% | 88 |
| playlist-generator-ch2 | 9050 | online | 79 MB | 0% | 27 |
| storage-service-ch2 | - | online | 145 MB | 0% | 28 |
| stream-guard-ch2 | - | online | 79 MB | 0% | 26 |
| stream-monitor-ch2 | - | online | 78 MB | 0% | 26 |
| cdn-prewarmer-ch2 | - | online | 93 MB | 0% | 25 |
| content-segmenter-ch2 | - | online | 77 MB | 0% | 25 |
| rtmp-receiver-ch2 | - | online | 85 MB | 0% | 25 |
| live-controller-ch2 | - | online | 70 MB | 0% | 25 |
...
| 9070 | unknown | - | all interfaces |
| 9100 | unknown | - | all interfaces |
| 36279 | chrome | stream-monitor-ch2 | 127.0.0.1 |
