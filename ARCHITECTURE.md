...
*Auto-generated on 2026-05-25 07:51 UTC*
...
**Memory:** 961.9 MB / 3.8 GB (24.6% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 52.8 GB | 30.2 GB | 20.0 GB | 61% |

### Docker Containers

| Name | Image | Ports | Status |
|------|-------|-------|--------|
| docker-proxy-1 | `nginx:1-alpine` | 1236:1236, 1236:1236, 8536:8536 | Up 15 hours |
| docker-lemmy-ui-1 | `dessalines/lemmy-ui:0.19.14` | 1234/tcp | Up 15 hours (healthy) |
| docker-lemmy-1 | `ghcr.io/gunswayfm/niteridefm_grid:latest` | 10002:10002, 10002:10002 | Up 15 hours |
| docker-postgres-1 | `pgautoupgrade/pgautoupgrade:16-alpine` | 5433:5432, 5433:5432 | Up 15 hours (healthy) |
| docker-pictrs-1 | `asonix/pictrs:0.5.16` | 6669/tcp, 8080/tcp | Up 15 hours |
...
| Load Average | 0.17, 0.07, 0.03 |

**Memory:** 993.9 MB / 5.8 GB (16.8% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 15.5 GB | 96.6 GB | 14% |
...
**Memory:** 929.0 MB / 5.8 GB (15.7% used)
...
| identity-service | 3001 | online | 100 MB | 3.1% | 21 |
...
| live-controller | - | online | 75 MB | 2.8% | 1 |
