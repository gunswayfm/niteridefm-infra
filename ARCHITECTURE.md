...
*Auto-generated on 2026-04-16 06:50 UTC*
...
**Memory:** 1.0 GB / 3.8 GB (27.2% used)
...
**Memory:** 915.1 MB / 5.8 GB (15.5% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 14.4 GB | 97.8 GB | 13% |
...
**Memory:** 930.4 MB / 5.8 GB (15.8% used)
...
| identity-service | 3001 | online | 97 MB | 0% | 20 |
...
| live-controller | - | online | 74 MB | 2.8% | 1 |
| playlist-generator-ch2 | 9050 | online | 74 MB | 2.8% | 6 |
...
| Kernel | 6.8.0-39-generic |
| Load Average | 1.02, 0.64, 0.52 |

**Memory:** 1.7 GB / 15.6 GB (11.2% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 156.4 GB | 41.9 GB | 108.0 GB | 28% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| streaming-core-ch2 | - | online | 94 MB | 0% | 1 |
| playlist-generator-ch2 | 9050 | online | 74 MB | 0% | 0 |
| storage-service-ch2 | - | online | 167 MB | 0% | 3023 |
