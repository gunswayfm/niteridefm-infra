...
*Auto-generated on 2026-04-13 06:58 UTC*
...
**Memory:** 920.5 MB / 5.8 GB (15.6% used)
...
**Memory:** 957.2 MB / 5.8 GB (16.2% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 8.8 GB | 103.3 GB | 8% |
...
| Kernel | 6.8.0-39-generic |
| Load Average | 1.06, 0.61, 0.50 |

**Memory:** 1.6 GB / 15.6 GB (10.6% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 156.4 GB | 37.4 GB | 112.6 GB | 25% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| streaming-core-ch2 | - | online | 91 MB | 0% | 1 |
| playlist-generator-ch2 | 9050 | online | 72 MB | 0% | 0 |
| storage-service-ch2 | - | online | 145 MB | 0% | 3023 |
