...
*Auto-generated on 2026-04-02 06:38 UTC*
...
**Memory:** 1010.1 MB / 3.8 GB (25.9% used)
...
**Memory:** 5.2 GB / 5.8 GB (90.4% used)
...
**Memory:** 891.6 MB / 5.8 GB (15.1% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 8.5 GB | 103.7 GB | 8% |
...
| OS | Ubuntu 24.04.1 LTS |
| Kernel | 6.8.0-39-generic |
| Load Average | 6.81, 6.68, 6.83 |

**Memory:** 2.0 GB / 15.6 GB (12.8% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 156.4 GB | 30.4 GB | 119.5 GB | 21% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| streaming-core-ch2 | - | online | 90 MB | 0% | 101 |
| playlist-generator-ch2 | 9050 | online | 78 MB | 0% | 35 |
| storage-service-ch2 | - | online | 142 MB | 0% | 31 |
| stream-guard-ch2 | - | online | 78 MB | 0% | 30 |
| stream-monitor-ch2 | - | online | 77 MB | 0% | 30 |
| cdn-prewarmer-ch2 | - | online | 99 MB | 0% | 31 |
| content-segmenter-ch2 | - | online | 72 MB | 0% | 28 |
| rtmp-receiver-ch2 | - | online | 78 MB | 0% | 28 |
| live-controller-ch2 | - | online | 68 MB | 0% | 28 |
