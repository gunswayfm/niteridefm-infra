...
*Auto-generated on 2026-03-27 06:37 UTC*
...
| Load Average | 1.02, 1.05, 1.02 |

**Memory:** 1017.5 MB / 3.8 GB (26.1% used)
...
| docker-proxy-1 | `nginx:1-alpine` | 1236:1236, 1236:1236, 8536:8536, 8536:8536 | Up 10 days |
| docker-lemmy-ui-1 | `dessalines/lemmy-ui:0.19.14` | 1234/tcp | Up 10 days (healthy) |
| docker-pictrs-1 | `asonix/pictrs:0.5.16` | 6669/tcp, 8080/tcp | Up 10 days |
| docker-postgres-1 | `pgautoupgrade/pgautoupgrade:16-alpine` | 5433:5432, 5433:5432 | Up 10 days (healthy) |
...
**Memory:** 5.0 GB / 5.8 GB (86.4% used)
...
**Memory:** 916.7 MB / 5.8 GB (15.5% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 8.3 GB | 103.8 GB | 8% |
...
| streaming-core | - | online | 99 MB | 2.8% | 21 |
...
| OS | Ubuntu 24.04.1 LTS |
| Kernel | 6.8.0-39-generic |
| Load Average | 7.67, 6.85, 6.74 |

**Memory:** 2.0 GB / 15.6 GB (12.6% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 156.4 GB | 34.1 GB | 115.8 GB | 23% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| streaming-core-ch2 | - | online | 90 MB | 0% | 87 |
| playlist-generator-ch2 | 9050 | online | 79 MB | 0% | 27 |
| storage-service-ch2 | - | online | 143 MB | 0% | 28 |
| stream-guard-ch2 | - | online | 74 MB | 0% | 26 |
| stream-monitor-ch2 | - | online | 78 MB | 0% | 26 |
| cdn-prewarmer-ch2 | - | online | 91 MB | 3.4% | 25 |
| content-segmenter-ch2 | - | online | 73 MB | 0% | 25 |
| rtmp-receiver-ch2 | - | online | 78 MB | 0% | 25 |
| live-controller-ch2 | - | online | 68 MB | 0% | 25 |
