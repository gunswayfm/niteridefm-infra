...
*Auto-generated on 2026-04-14 06:49 UTC*
...
**Memory:** 1.1 GB / 3.8 GB (28.4% used)
...
|------|-------|-------|--------|
| docker-lemmy-1 | `ghcr.io/gunswayfm/niteridefm_grid:latest` | 10002:10002, 10002:10002 | Up 54 minutes |
...
**Memory:** 934.0 MB / 5.8 GB (15.8% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 14.2 GB | 97.9 GB | 13% |
...
**Memory:** 930.1 MB / 5.8 GB (15.8% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 8.9 GB | 103.3 GB | 8% |
...
| identity-service | 3001 | online | 98 MB | 0% | 19 |
...
| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 117.0 GB | 42.7 GB | 69.4 GB | 39% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| playlist-generator-ch1 | 9050 | online | 80 MB | 2.7% | 19 |
...
| Kernel | 6.8.0-39-generic |
| Load Average | 0.43, 0.40, 0.37 |

**Memory:** 1.8 GB / 15.6 GB (11.7% used)

### Disk Usage

| Mount | Size | Used | Available | % |
|-------|------|------|-----------|---|
| `/` | 156.4 GB | 35.9 GB | 114.0 GB | 24% |

### PM2 Services

| Name | Port | Status | Memory | CPU | Restarts |
|------|------|--------|--------|-----|----------|
| streaming-core-ch2 | - | online | 93 MB | 0% | 1 |
| playlist-generator-ch2 | 9050 | online | 73 MB | 0% | 0 |
| storage-service-ch2 | - | online | 151 MB | 0% | 3023 |
| stream-guard-ch2 | - | online | 79 MB | 0% | 0 |
| stream-monitor-ch2 | - | errored | 0 MB | 0% | 15 |
| cdn-prewarmer-ch2 | - | errored | 0 MB | 0% | 15 |
| content-segmenter-ch2 | - | online | 81 MB | 0% | 0 |
